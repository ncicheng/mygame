...
const child = spawn(
  process.execPath,
  ['--import', 'tsx', '--test', 'test/db.integration.test.ts', 'test/auth.integration.test.ts', 'test/world.integration.test.ts', 'test/recruit.integration.test.ts', 'test/march.integration.test.ts', 'test/battle.integration.test.ts', 'test/socket.integration.test.ts', 'test/schema.integration.test.ts'],
